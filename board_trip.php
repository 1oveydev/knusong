...
<body>
    ...
    <header class="masthead6">
        <div class="container">
            <div class="masthead6-subheading">Trip, 여행
            </div>
            <div class="masthead6-heading text-uppercase">오늘 드라이브 어때요?</div>
        </div>
    </header>
...
<?php
		...
		$query ="select * from board_trip order by number desc";
...
?>			
                <tr>
                    ...
                    <td id="title">
                        ...
                        <a href="./view.php?number=<?php echo $rows['number']?>&board_info=board_trip"><?php echo $rows['title']?></a>
                    </td>
...
?>
    ...
    <button id="btn_write" type="button"  onclick="location.href='./write_trip.php' ">Post</button>
</div>
<!-- Footer-->
