...
<body>
    ...
    <header class="masthead">
        <div class="container">
            <div class="masthead-subheading">Love, 사랑</div>
            <div class="masthead-heading text-uppercase">'희노애락', 그 중 세번째 감정.</div>
        </div>
    </header>
...
<?php
		...
		$query ="select * from board_love order by number desc";
...
?>			
                <tr>
                    ...
                    <td id="title">
                        ...
                        <a href="./view.php?number=<?php echo $rows['number']?>&board_info=board_love"><?php echo $rows['title']?></a>
                    </td>
...
?>
    ...
    <button id="btn_write" type="button"  onclick="location.href='./write_love.php' ">Post</button>
</div>
<!-- Footer-->
