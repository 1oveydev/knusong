...
<body>
    ...
    <header class="masthead3">
        <div class="container">
            <div class="masthead3-subheading">Farewall, 이별</div>
            <div class="masthead3-heading text-uppercase">네가 전부였는데, 이젠 아닌 것.</div>
        </div>
    </header>
...
<?php
		...
		$query ="select * from board_farewall order by number desc";
...
?>			
                <tr>
                    ...
                    <td id="title">
                        ...
                        <a href="./view.php?number=<?php echo $rows['number']?>&board_info=board_farewall"><?php echo $rows['title']?></a>
                    </td>
...
?>
    ...
    <button id="btn_write" type="button"  onclick="location.href='./write_farewall.php' ">Post</button>
</div>
<!-- Footer-->
