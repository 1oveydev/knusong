...
<body>
    ...
    <header class="masthead4">
        <div class="container">
            <div class="masthead4-subheading">Freedom, 자유</div>
            <div class="masthead4-heading text-uppercase">무엇이든지 하고 싶은대로,</div>
        </div>
    </header>
...
<?php
		...
		$query ="select * from board_freedom order by number desc";
...
?>			
                <tr>
                    ...
                    <td id="title">
                        ...
                        <a href="./view.php?number=<?php echo $rows['number']?>&board_info=board_freedom"><?php echo $rows['title']?></a>
                    </td>
...
?>
    ...
    <button id="btn_write" type="button"  onclick="location.href='./write_freedom.php' ">Post</button>
</div>
<!-- Footer-->
