...
<body>
    ...
    <header class="masthead5">
        <div class="container">
            <div class="masthead5-subheading">Study, 학업
            </div>
            <div class="masthead5-heading text-uppercase">배움에 끝이 어디 있나요, 자책하지 마요</div>
        </div>
    </header>
...
<?php
		...
		$query ="select * from board_study order by number desc";
...
?>			
                <tr>
                    ...
                    <td id="title">
                        ...
                        <a href="./view.php?number=<?php echo $rows['number']?>&board_info=board_study"><?php echo $rows['title']?></a>
                    </td>
...
?>
    ...
    <button id="btn_write" type="button"  onclick="location.href='./write_study.php' ">Post</button>
</div>
<!-- Footer-->
